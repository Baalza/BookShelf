...
public class Book {
    ...
    public static final String BOOK_REPORT_JPQL = "Select new com.kaisen.book.model.BookReport" +
    ...
    public static final String BOOK_AUTHOR_JPQL = "Select new com.kaisen.book.model.BookReport" +
